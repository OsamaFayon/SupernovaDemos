...
public extension Color {
    ...
    struct TokenColor {
        public let token1 = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 1) 
        public let snToken = Color(.sRGB, red: 197/255, green: 135/255, blue: 135/255, opacity: 1) 
        public let token2 = Color(.sRGB, red: 146/255, green: 56/255, blue: 56/255, opacity: 1) 
        public let neutral900 = Color(.sRGB, red: 20/255, green: 23/255, blue: 31/255, opacity: 1) 
        public let primary200 = Color(.sRGB, red: 237/255, green: 245/255, blue: 255/255, opacity: 1) 
        public let primary600 = Color(.sRGB, red: 15/255, green: 98/255, blue: 254/255, opacity: 1) 
        public let red600 = Color(.sRGB, red: 203/255, green: 16/255, blue: 29/255, opacity: 1) 
        public let white = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 1) 
        public let neutral400 = Color(.sRGB, red: 96/255, green: 105/255, blue: 129/255, opacity: 1) 
        public let neutral500 = Color(.sRGB, red: 199/255, green: 205/255, blue: 219/255, opacity: 1) 
        public let neutral200Opaque = Color(.sRGB, red: 24/255, green: 45/255, blue: 102/255, opacity: 0.04) 
        public let neutral100Opaque = Color(.sRGB, red: 20/255, green: 26/255, blue: 43/255, opacity: 0.02) 
        public let primary400 = Color(.sRGB, red: 208/255, green: 226/255, blue: 255/255, opacity: 1) 
        public let primary700 = Color(.sRGB, red: 0/255, green: 78/255, blue: 225/255, opacity: 1) 
        public let red100 = Color(.sRGB, red: 254/255, green: 241/255, blue: 242/255, opacity: 1) 
        public let green100 = Color(.sRGB, red: 235/255, green: 254/255, blue: 246/255, opacity: 1) 
        public let green600 = Color(.sRGB, red: 5/255, green: 117/255, blue: 31/255, opacity: 1) 
        public let purple100 = Color(.sRGB, red: 245/255, green: 242/255, blue: 253/255, opacity: 1) 
        public let purple600 = Color(.sRGB, red: 135/255, green: 76/255, blue: 230/255, opacity: 1) 
        public let purple700 = Color(.sRGB, red: 106/255, green: 43/255, blue: 191/255, opacity: 1) 
        public let orange100 = Color(.sRGB, red: 254/255, green: 248/255, blue: 235/255, opacity: 1) 
        public let orange200 = Color(.sRGB, red: 251/255, green: 229/255, blue: 197/255, opacity: 1) 
        public let orange500 = Color(.sRGB, red: 204/255, green: 77/255, blue: 0/255, opacity: 1) 
        public let orange600 = Color(.sRGB, red: 181/255, green: 60/255, blue: 10/255, opacity: 1) 
        public let snToken = Color(.sRGB, red: 150/255, green: 53/255, blue: 53/255, opacity: 1) 
        public let snToken = Color(.sRGB, red: 143/255, green: 72/255, blue: 72/255, opacity: 1) 
        public let snToken = Color(.sRGB, red: 152/255, green: 35/255, blue: 35/255, opacity: 1) 
        public let snToken = Color(.sRGB, red: 180/255, green: 85/255, blue: 85/255, opacity: 1) 
        public let snToken = Color(.sRGB, red: 206/255, green: 76/255, blue: 76/255, opacity: 1) 
        public let snToken = Color(.sRGB, red: 173/255, green: 64/255, blue: 64/255, opacity: 1) 
        public let snToken = Color(.sRGB, red: 197/255, green: 26/255, blue: 26/255, opacity: 1) 
        ...
        public let foregroundNeutralFaded = Color(.sRGB, red: 96/255, green: 105/255, blue: 129/255, opacity: 1) 
        public let foregroundPrimary = Color(.sRGB, red: 15/255, green: 98/255, blue: 254/255, opacity: 1) 
        public let foregroundCritical = Color(.sRGB, red: 203/255, green: 16/255, blue: 29/255, opacity: 1) 
        public let foregroundWarning = Color(.sRGB, red: 181/255, green: 60/255, blue: 10/255, opacity: 1) 
        public let foregroundPositive = Color(.sRGB, red: 5/255, green: 117/255, blue: 31/255, opacity: 1) 
        public let foregroundUpgrade = Color(.sRGB, red: 135/255, green: 76/255, blue: 230/255, opacity: 1) 
        public let foregroundDisabled = Color(.sRGB, red: 199/255, green: 205/255, blue: 219/255, opacity: 1) 
        public let foregroundPlaceholder = Color(.sRGB, red: 127/255, green: 134/255, blue: 148/255, opacity: 1) 

        // Background
        public let backgroundElevationBase = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 1) 
        public let backgroundElevationRaised = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 1) 
        public let backgroundElevationOverlay = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 1) 
        public let backgroundNeutral = Color(.sRGB, red: 24/255, green: 45/255, blue: 102/255, opacity: 0.04) 
        public let backgroundNeutralFaded = Color(.sRGB, red: 20/255, green: 26/255, blue: 43/255, opacity: 0.02) 
        public let backgroundNeutralHighlighted = Color(.sRGB, red: 24/255, green: 45/255, blue: 102/255, opacity: 0.08) 
        public let backgroundPage = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 1) 
        public let backgroundPageFaded = Color(.sRGB, red: 250/255, green: 250/255, blue: 250/255, opacity: 1) 
        public let backgroundPrimary = Color(.sRGB, red: 15/255, green: 98/255, blue: 254/255, opacity: 1) 
        public let backgroundPrimaryHighlighted = Color(.sRGB, red: 0/255, green: 78/255, blue: 225/255, opacity: 1) 
        public let backgroundPrimaryFaded = Color(.sRGB, red: 237/255, green: 245/255, blue: 255/255, opacity: 1) 
        public let backgroundCritical = Color(.sRGB, red: 226/255, green: 44/255, blue: 44/255, opacity: 1) 
        public let backgroundCriticalHighlighted = Color(.sRGB, red: 203/255, green: 16/255, blue: 29/255, opacity: 1) 
        public let backgroundCriticalFaded = Color(.sRGB, red: 254/255, green: 241/255, blue: 242/255, opacity: 1) 
        public let backgroundWarning = Color(.sRGB, red: 204/255, green: 77/255, blue: 0/255, opacity: 1) 
        public let backgroundWarningHighlighted = Color(.sRGB, red: 181/255, green: 60/255, blue: 10/255, opacity: 1) 
        public let backgroundWarningFaded = Color(.sRGB, red: 254/255, green: 248/255, blue: 235/255, opacity: 1) 
        public let backgroundPositive = Color(.sRGB, red: 17/255, green: 136/255, blue: 80/255, opacity: 1) 
        public let backgroundPositiveHighlighted = Color(.sRGB, red: 5/255, green: 117/255, blue: 31/255, opacity: 1) 
        public let backgroundPositiveFaded = Color(.sRGB, red: 235/255, green: 254/255, blue: 246/255, opacity: 1) 
        public let backgroundUpgrade = Color(.sRGB, red: 135/255, green: 76/255, blue: 230/255, opacity: 1) 
        public let backgroundUpgradeHighlighted = Color(.sRGB, red: 106/255, green: 43/255, blue: 191/255, opacity: 1) 
        public let backgroundUpgradeFaded = Color(.sRGB, red: 245/255, green: 242/255, blue: 253/255, opacity: 1) 
        public let backgroundBlur = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 0.95) 
        public let backgroundBlurNeutral = Color(.sRGB, red: 244/255, green: 245/255, blue: 247/255, opacity: 0.95) 
        public let backgroundBlurNeutralHighlighted = Color(.sRGB, red: 236/255, green: 237/255, blue: 240/255, opacity: 0.95) 
        public let backgroundDisabled = Color(.sRGB, red: 24/255, green: 45/255, blue: 102/255, opacity: 0.04) 
        public let backgroundDisabledFaded = Color(.sRGB, red: 20/255, green: 26/255, blue: 43/255, opacity: 0.02) 
        public let backgroundFocusHighlight = Color(.sRGB, red: 208/255, green: 226/255, blue: 255/255, opacity: 1) 

        // Border
        public let borderNeutral = Color(.sRGB, red: 199/255, green: 205/255, blue: 219/255, opacity: 1) 
        public let borderNeutralFaded = Color(.sRGB, red: 236/255, green: 238/255, blue: 243/255, opacity: 1) 
        public let borderPrimary = Color(.sRGB, red: 0/255, green: 78/255, blue: 225/255, opacity: 1) 
        public let borderPrimaryFaded = Color(.sRGB, red: 208/255, green: 226/255, blue: 255/255, opacity: 1) 
        public let borderCritical = Color(.sRGB, red: 203/255, green: 16/255, blue: 29/255, opacity: 1) 
        public let borderCriticalFaded = Color(.sRGB, red: 251/255, green: 213/255, blue: 216/255, opacity: 1) 
        public let borderWarning = Color(.sRGB, red: 181/255, green: 60/255, blue: 10/255, opacity: 1) 
        public let borderWarningFaded = Color(.sRGB, red: 251/255, green: 229/255, blue: 197/255, opacity: 1) 
        public let borderPositive = Color(.sRGB, red: 5/255, green: 117/255, blue: 31/255, opacity: 1) 
        public let borderPositiveFaded = Color(.sRGB, red: 205/255, green: 237/255, blue: 213/255, opacity: 1) 
        public let borderUpgrade = Color(.sRGB, red: 106/255, green: 43/255, blue: 191/255, opacity: 1) 
        public let borderUpgradeFaded = Color(.sRGB, red: 227/255, green: 219/255, blue: 250/255, opacity: 1) 
        public let borderDisabled = Color(.sRGB, red: 223/255, green: 226/255, blue: 234/255, opacity: 1) 
        public let borderFocus = Color(.sRGB, red: 69/255, green: 137/255, blue: 255/255, opacity: 1) 

        // On background
        public let onBackgroundNeutral = Color(.sRGB, red: 20/255, green: 23/255, blue: 31/255, opacity: 1) 
        public let onBackgroundPrimary = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 1) 
        public let onBackgroundCritical = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 1) 
        public let onBackgroundWarning = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 1) 
        public let onBackgroundPositive = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 1) 
        public let onBackgroundUpgrade = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 1) 

        // Persistent
        public let persistentBlack = Color(.sRGB, red: 20/255, green: 23/255, blue: 31/255, opacity: 1) 
        public let persistentWhite = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 1) 

        // Decorative
        public let decorativeBlueForeground = Color(.sRGB, red: 15/255, green: 98/255, blue: 254/255, opacity: 1) 
        public let decorativeBlueBackground = Color(.sRGB, red: 237/255, green: 245/255, blue: 255/255, opacity: 1) 
        public let decorativeCyanForeground = Color(.sRGB, red: 14/255, green: 116/255, blue: 144/255, opacity: 1) 
        public let decorativeCyanBackground = Color(.sRGB, red: 213/255, green: 251/255, blue: 254/255, opacity: 1) 
        public let decorativeFuchsiaForeground = Color(.sRGB, red: 183/255, green: 37/255, blue: 203/255, opacity: 1) 
        public let decorativeFuchsiaBackground = Color(.sRGB, red: 252/255, green: 240/255, blue: 255/255, opacity: 1) 
        public let decorativeGreenForeground = Color(.sRGB, red: 5/255, green: 117/255, blue: 31/255, opacity: 1) 
        public let decorativeGreenBackground = Color(.sRGB, red: 235/255, green: 254/255, blue: 246/255, opacity: 1) 
        public let decorativeGreyForeground = Color(.sRGB, red: 78/255, green: 83/255, blue: 106/255, opacity: 1) 
        public let decorativeGreyBackground = Color(.sRGB, red: 237/255, green: 239/255, blue: 243/255, opacity: 1) 
        public let decorativeLightGreyForeground = Color(.sRGB, red: 104/255, green: 113/255, blue: 141/255, opacity: 1) 
        public let decorativeLightGreyBackground = Color(.sRGB, red: 246/255, green: 247/255, blue: 249/255, opacity: 1) 
        public let decorativeOrangeForeground = Color(.sRGB, red: 194/255, green: 65/255, blue: 12/255, opacity: 1) 
        public let decorativeOrangeBackground = Color(.sRGB, red: 255/255, green: 242/255, blue: 225/255, opacity: 1) 
        public let decorativePurpleForeground = Color(.sRGB, red: 135/255, green: 76/255, blue: 230/255, opacity: 1) 
        public let decorativePurpleBackground = Color(.sRGB, red: 245/255, green: 242/255, blue: 253/255, opacity: 1) 
        public let decorativePinkForeground = Color(.sRGB, red: 209/255, green: 35/255, blue: 114/255, opacity: 1) 
        public let decorativePinkBackground = Color(.sRGB, red: 253/255, green: 240/255, blue: 247/255, opacity: 1) 
        public let decorativeRedForeground = Color(.sRGB, red: 203/255, green: 16/255, blue: 29/255, opacity: 1) 
        public let decorativeRedBackground = Color(.sRGB, red: 254/255, green: 241/255, blue: 242/255, opacity: 1) 
        public let decorativeTealForeground = Color(.sRGB, red: 16/255, green: 122/255, blue: 113/255, opacity: 1) 
        public let decorativeTealBackground = Color(.sRGB, red: 223/255, green: 253/255, blue: 246/255, opacity: 1) 
        public let decorativeYellowForeground = Color(.sRGB, red: 161/255, green: 98/255, blue: 7/255, opacity: 1) 
        public let decorativeYellowBackground = Color(.sRGB, red: 254/255, green: 249/255, blue: 195/255, opacity: 1) 
        public let decorativeNewDecorative = Color(.sRGB, red: 255/255, green: 255/255, blue: 255/255, opacity: 1) 
